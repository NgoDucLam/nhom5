...
public class Product_Adapter extends RecyclerView.Adapter<Product_Adapter.UserViewHolder>{
    ...
    @NonNull
    @Override
    public Product_Adapter.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Product_Adapter.UserViewHolder holder, int position) {
